...
// New Booking Screen with original design
...
const ActiveBookingScreen = () => (
  <View style={styles.screenContainer}>
    <Text style={styles.screenText}>Active Booking Screen</Text>
  </View>
);

const HomeScreen = () => {
  const [modalVisible, setModalVisible] = useState(false);
  const [submenuVisible, setSubmenuVisible] = useState(false);  // State for submenu visibility
...
// Styles for submenu and other components
const styles = StyleSheet.create({
  ...
  subMenuItem: {
    paddingLeft: 30,  // Indentation for submenu items
    paddingVertical: 5,
  },
  subMenuText: {
    fontSize: 12,  // Smaller font for submenu items
    color: 'gray',
  },
  modalContainer: {
    flex: 1,
  ...
  modalContent: {
    ...
    flexGrow: 1,  // Allow modal content to grow to fit content dynamically
    justifyContent: 'flex-start', // Avoid unnecessary scrolling
  ...
  screenText: { fontSize: 20, color: 'black' },
